...
headers = {'Accept': 'application/vnd.edusoho.v2+json', 'Accept-Encoding': 'gzip, deflate',
           'Accept-Language': 'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7', 'Connection': 'keep-alive', 'Content-Length': '23',
           ...
           'Host': 'www.yaiedu.com', 'Origin': 'http://www.yaiedu.com',
           'Referer': 'http://www.yaiedu.com/lesson/526/testpaper/51/do',
           'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36',
           'X-CSRF-Token': '5bHd-jUvt--PXbJiho7NcggrdUO-ha0VDTQGP7xZDJM', 'X-Requested-With': 'XMLHttpRequest'}
